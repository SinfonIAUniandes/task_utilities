...
class STICKLER_RULES(object):
    def __init__(self):
        ...
        self.places_available = ["living_room", "kitchen", "bedroom", "study"]
        self.places_i = 0
        self.places_instructions = {
            "living_room":{"angle": 0, "width": 0, "is_forbidden": False},
            "kitchen":{"angle": 0, "width": 0, "is_forbidden": False},
            "bedroom":{"angle": 0, "width": 0, "is_forbidden": True},
            "study":{"angle": 0, "width": 0, "is_forbidden": False}
        }   
        self.rules = {
    ...
    def on_enter_CHECK_RULE(self):
        ...
        while(time.time()-t2 < 5):
            for label in self.default_labels:
                if(label["label"] == "drink") and (320*0.2<label["x"]<320*0.8):
                    print("drink found")
                    drink_broken = False
                    break
        ...
        self.tm.talk("Guest, thank you for following instructions")
        self.good_person()
