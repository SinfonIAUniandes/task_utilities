...
class ServeBreakfast(object):
    def __init__(self) -> None:
        ...
        self.states = ['INIT', 'GO_TO_CUPBOARD', 'LOOK_4_ITEM', 'GRAB_OBJECT', 'GO_TO_DROP_PLACE', 'DROP', 'MAKE_BREAKFAST', 'END', 'DINING']
    ...
    def on_enter_INIT(self):
        ...
        self.tm.set_current_place("init_serve")
    ...
    def on_enter_GO_TO_CUPBOARD(self):
        ...
        self.tm.talk("I arrived to the kitchen", "English", wait=False)
    ...
    def on_enter_GO_TO_DROP_PLACE(self):
        ...
        self.tm.go_to_relative_point(0.0,-1.2,0.0)
    ...
    def on_enter_DINING(self):
        print(self.consoleFormatter.format("DINING", "HEADER"))
        self.tm.enable_security_proxy()
        self.tm.go_to_relative_point(0.0,-1.2,0.0)
        self.recognize()
