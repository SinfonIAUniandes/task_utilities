...
class RECEPTIONIST(object):
    ...
    def on_enter_INTRODUCE_NEW(self):
        ...
        self.tm.talk(
            f'Hello everyone, this is {self.current_guest["name"]}, {self.current_guest["pronoun"]} is a {self.current_guest["gender"]}.  {self.current_guest["pronoun"]} is {self.current_guest["age"]}, and {self.current_guest["pronoun"]} likes to drink {self.current_guest["drink"]}. {self.current_guest["pronoun"]} {has_beard_str}, {has_hat_str}, and {has_glasses_str}',
            "English",
        )
