...
class CLEAN_THE_TABLE(object):
    def __init__(self) -> None:
        ...
        states = ["INIT", "GO2KITCHEN", "GO2TABLE"]
        ...
        transitions = [{'trigger': 'start', 'source': 'CTT', 'dest': 'INIT'},
                       {'trigger': 'init_go2kitchen', 'source': 'INIT', 'dest': 'GO2KITCHEN'},
                       {'trigger': 'init_gograbplace', 'source': 'GO2KITCHEN', 'dest': 'GO_GRAB_PLACE'}
                       ...
                       {'trigger': 'go_drop_object', 'source': 'GO_DROP_PLACE', 'dest': 'GO_DROP_OBJECT'},
                       ...
                       {'trigger': 'again', 'source': 'GO_DROP_OBJECT', 'dest': 'GO_GRAB_PLACE'},
        ...
        self.object_instructions = {
            "spoon":{"grap_place":"grap_place", "drop_place":"drop_place", "forward_distance":0.35, "backward_distance":0.35},
            "fork":{"grap_place":"grap_place", "drop_place":"drop_place", "forward_distance":0.4, "backward_distance":0.4},
            "knife":{"grap_place":"grap_place", "drop_place":"drop_place", "forward_distance":0.35, "backward_distance":0.35},
            "dish":{"grap_place":"grap_place", "drop_place":"drop_place", "forward_distance":0.35, "backward_distance":0.35},
        }
    ...
    def on_enter_GO_DROP_OBJECT(self):
        navigation_drop_place = self.object_instructions[self.object]["drop_place"]
        self.tm.talk("I am navigating to the "+navigation_drop_place)
        self.tm.go_to_place(navigation_drop_place)
        self.drop_object()
    ...
    def on_enter_DROP_OBJECT(self):
        self.tm.talk("I am going to place the "+self.object+" on the table")
