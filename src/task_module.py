...
>>>>>>> d91220d9adf06d0cbed41d3cf462f6a3f12b30d6
...
<<<<<<< HEAD
            ...
            print(
                self.consoleFormatter.format(
                    "Waiting for perception_utilities/get_person_description...",
                    "WARNING",
                )
            )
            rospy.wait_for_service("/perception_utilities/get_person_description_srv")
            self.get_person_description_proxy = rospy.ServiceProxy(
                "/perception_utilities/get_person_description_srv",
                get_person_description_srv,
            )
