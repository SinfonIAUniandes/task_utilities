...
class Evento(object):
    ...
    def on_enter_WAIT4GUEST(self):
        ...
        self.hearing = False
        self.tm.talk("Bienvenido, soy Nova, es un gusto conocerte","Spanish",animated=False) #TODO: Cambiar para que diga cosas más interesantes
        self.tm.talk("Di Hey Nova cuando quieras decirme algo, y chao cuando no quieras seguir hablando","Spanish",animated=True) #TODO: Cambiar para que diga cosas más interesantes
        rospy.sleep(0.9)
    ...
    def on_enter_Q_A(self):
        ...
        anim_msg = self.gen_anim_msg("Gestures/BowShort_3") #TODO: Cambiar gesto
        self.animationPublisher.publish(anim_msg)
        self.hearing = False
